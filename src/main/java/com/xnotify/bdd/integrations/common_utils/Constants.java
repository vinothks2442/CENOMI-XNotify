...
public class Constants {
	...
	public static final String MOBILE_FEATURE="src/test/java/com/Gypsee/bdd/mobile/features";
	public static final String MOBILE_STEPDEFINITIONS="com/Gypsee/bdd/mobile/stepdefinitions";
