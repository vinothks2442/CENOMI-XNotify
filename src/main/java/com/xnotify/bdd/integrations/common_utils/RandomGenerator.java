...
public final class RandomGenerator {
	 ...
	 *
	 * @param length length of random alphanumeric characters to be generated for
	 *               the local part of email address
	 */
	public static String randomEmailAddress(Integer length) {
		String email = randomAlphanumeric(length) + "@gmail.com";
